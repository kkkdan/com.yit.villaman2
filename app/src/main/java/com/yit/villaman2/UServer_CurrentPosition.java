...
//						+ URLEncoder.encode("poitype", "UTF-8") + "=" +URLEncoder.encode("" + detailMap.get("poitype"), "UTF-8");
				...
				data = URLEncoder.encode("sido", "UTF-8") + "=" + URLEncoder.encode("" + detailMap.get("sido"), "UTF-8") + "&"
						...
						+ URLEncoder.encode("ma_mae_ney1", "UTF-8") + "=" + URLEncoder.encode("" + detailMap.get("ma_mae_ney1"), "UTF-8") + "&"
						+ URLEncoder.encode("ma_mae_ney2", "UTF-8") + "=" + URLEncoder.encode("" + detailMap.get("ma_mae_ney2"), "UTF-8") + "&"
